...
urlpatterns = [
    ...
    # path('support-center/', include('health_.urls')),
    path('nursing/', include('health_nursing.urls')),
    # path('ambulances/', include('health_.urls')),
    path('health-services/', include('health_.urls')),
    path('reporting/', include('health_services.urls')),
    path('genetics/', include('health_genetics.urls')),
    # path('dx-imaging/', include('health.urls')),
    path('laboratory-info/', include('health_lab.urls')),
    # path('medicaments/', include('health.urls')),
    # path('immunization-shedule/', include('health_.urls')),
    path('procedures/', include('health_procedures.urls')),
    path('federation/', include('health_federation.urls')),
    # path('configuration/', include('health_.urls')),
    # path('functionality-disability/', include('health_.urls')),
    # path('institutions-hospital/', include('health_.urls')),
    path('federation-configuration/', include('health_federation.urls')),
    # path('misc/', include('health.urls')),
]
