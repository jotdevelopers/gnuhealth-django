...
urlpatterns = [
    ...
    path('nursing/', include('health_.urls')),
    path('ambulances/', include('health_.urls')),
    path('health-services/', include('health_.urls')),
    path('reporting/', include('health_.urls')),
    path('genetics/', include('health_.urls')),
    path('dx-imaging/', include('health_.urls')),
    path('laboratory-info/', include('health_.urls')),
    path('medicaments/', include('health_.urls')),
    ...
    path('federation-configuration/', include('health_.urls')),
    path('misc/', include('health_.urls')),
]
