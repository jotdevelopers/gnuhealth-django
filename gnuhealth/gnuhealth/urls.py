...
urlpatterns = [
    ...
    path('dashboard/', include('health_dashboard.urls')),
    path('pediatrics/', include('health_pediatrics.urls')),
    path('obstetrics/', include('health_obstetrics.urls')),
    path('archives/', include('health_archives.urls')),
    path('support-center/', include('health_support_center.urls')),
    path('nursing/', include('health_nursing.urls')),
    path('ambulances/', include('health_ambulances.urls')),
    path('health-services/', include('health_services.urls')),
    path('reporting/', include('health_reporting.urls')),
    path('genetics/', include('health_genetics.urls')),
    path('dx-imaging/', include('health_dx_imaging.urls')),
    path('laboratory-info/', include('health_lab.urls')),
    path('medicaments/', include('health_medicaments.urls')),
    path('immunization-shedule/', include('health_immunization_schedule.urls')),
    path('procedures/', include('health_procedures.urls')),
    path('federation/', include('health_federation.urls')),
    path('configuration/', include('health_medicaments.urls')),
    path('functionality-disability/', include('health_functionality_disability.urls')),
    path('institutions-hospital/', include('health_institutions_hospital.urls')),
    path('federation-configuration/', include('health_federation.urls')),
    path('misc/', include('health_misc.urls')),
]
