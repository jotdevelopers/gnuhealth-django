...
urlpatterns = [
    ...
    path('searchMedicament/<search_text>/', views.searchMedicament, name='searchMedicament'),
    path('searchDoseUnit/<search_text>/', views.searchDoseUnit, name='searchDoseUnit'),
